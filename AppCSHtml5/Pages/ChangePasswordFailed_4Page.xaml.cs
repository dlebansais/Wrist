...
{
    public partial class change_password_failed__4Page : Page
    {
        public change_password_failed__4Page()
        {
            InitializeComponent();
            DataContext = this;
        }
        ...
        private void GoTo_Language_Switch__change_password_failed__4Page(object sender, RoutedEventArgs e)
        {
            string Content = (sender as Button).Content as string;
            Language.On_Switch("change password failed #4", "other language", Content);
